...
class BarcodeInputklarschlammasche extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.first_weight_data) {
      ...
      this.props.history.push('SignatureLableklarschlammasche', {
        state: {
  ...
  gotoHome() {
    this.props.history.push('AnnahmeklarschlammascheHome')
...
export default connect(mapStateToProps, mapDispatchToProps)(BarcodeInputklarschlammasche);
