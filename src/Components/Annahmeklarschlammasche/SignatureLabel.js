...
class SignatureLableklarschlammasche extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.order_second_detail_data) {
            ...
            this.props.history.push('OverLayoutklarschlammasche', {
...
export default connect(mapStateToProps, mapDispatchToProps) ( SignatureLableklarschlammasche );
