...
var tempintervalid = '';
class ThanksLayoutklarschlammasche extends Component {
    ...
    componentDidMount() {
        ...
        tempintervalid = setInterval(() => { this.props.history.push('AnnahmeklarschlammascheHome') }, 3000)
...
export default ThanksLayoutklarschlammasche;
