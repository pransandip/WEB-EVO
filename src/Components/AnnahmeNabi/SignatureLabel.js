...
class SignatureLableAnnahmeNabi extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.order_second_detail_data) {
            ...
            this.props.history.push('ThanksLayoutAnnahmeNabi', {
    ...
    gotoNext() {
        this.props.history.push('OverLayoutAnnahmeNabi');
    }

    gotoHome() {
        this.props.history.push('AnnahmeNabiHome');
    }
...
export default connect(mapStateToProps, mapDispatchToProps) (SignatureLableAnnahmeNabi);
