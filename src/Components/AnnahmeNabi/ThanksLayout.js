...
var tempintervalid = '';
class ThanksLayoutAnnahmeNabi extends Component {
    ...
    componentDidMount() {
        ...
        tempintervalid = setInterval(() => { this.props.history.push('AnnahmeNabiHome') }, 3000)
...
export default ThanksLayoutAnnahmeNabi;
