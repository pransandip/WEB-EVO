...
class WaittodriveAnnahmeKlärschlammascheEingangswaage extends Component {
    ...
    gotoNext() {
        this.props.history.push('WaittodriveTimerAnnahmeKlärschlammascheEingangswaage');
    }
...
export default WaittodriveAnnahmeKlärschlammascheEingangswaage;
