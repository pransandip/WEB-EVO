...
class WaittodriveTimerAnnahmeAmmoniakwasserEingangswaage extends Component {
    ...
    gotoHome() {
        this.props.history.push('AnnahmeAmmoniakwasserEingangswaageHome');
    }
                ...
                <Container style={{ background: '', height: '435px' }} >
                    <Row style={{ marginTop: '40px' }}>
                        <div style={{ marginTop: '80px', marginLeft: 'auto', marginRight: 'auto', width: '603px', textAlign: 'center' }}>
                            <label style={{ fontSize: '25px', fontWeight: 'bold', color: '#000947', marginLeft: '20px', marginTop: '14px' }} >{localLangData[localStorage.getItem('lang')].waitToDrivelbl_Annahme_Amoniak}</label>
...
export default WaittodriveTimerAnnahmeAmmoniakwasserEingangswaage;
