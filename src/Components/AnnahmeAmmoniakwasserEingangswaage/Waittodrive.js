...
class WaittodriveAnnahmeAmmoniakwasserEingangswaage extends Component {
    ...
    gotoNext() {
        this.props.history.push('WaittodriveTimerAnnahmeAmmoniakwasserEingangswaage');
    }
...
export default WaittodriveAnnahmeAmmoniakwasserEingangswaage;
