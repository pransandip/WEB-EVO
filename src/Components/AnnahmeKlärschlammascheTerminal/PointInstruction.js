...
class PointInstructionAnnahmeKlärschlammascheTerminal extends Component {
    ...
    gotoNext() {
        this.props.history.push('ThanksLayoutAnnahmeKlärschlammascheTerminal');
    }
...
export default PointInstructionAnnahmeKlärschlammascheTerminal;
