...
class BarcodeScanAnnahmeKlärschlammascheTerminal extends Component {
    ...
    gotoNext() {
        this.props.history.push('BarcodeInputAnnahmeKlärschlammascheTerminal');
    }
             ...
             <div  style={{
                ...
                <Row style={{ marginTop: '50px' }}>
                        <div style={{ marginTop: '30px', marginLeft: 'auto', marginRight: 'auto', width: '603px', textAlign:'center' }}>
                            <label style={{ fontSize: '25px', fontWeight: 'bold', color: '#000947', marginLeft: '20px', marginTop: '14px' }} >{localLangData[localStorage.getItem('lang')].terminalbarcodescan}</label>
                        </div>
                        <div style={{
                            ...
                            <img style={{ marginLeft: '-15px' }} src={imageReader} />
                        </div>
                    </Row>
                </Container>
                <Row>
...
export default BarcodeScanAnnahmeKlärschlammascheTerminal;
