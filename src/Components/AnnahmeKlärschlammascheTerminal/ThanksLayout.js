...
var tempintervalid = '';
class ThanksLayoutAnnahmeKlärschlammascheTerminal extends Component {
    ...
    componentDidMount() {
        ...
        tempintervalid = setInterval(() => { this.props.history.push('AnnahmeKlärschlammascheTerminalHome') }, 3000)
...
export default ThanksLayoutAnnahmeKlärschlammascheTerminal;
