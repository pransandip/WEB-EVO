                        ...
                        <Row style={{ marginTop: '100px' }}>
                            <Col>
                                ...
                                <Row style={{ marginTop: '20px' }}>
                                    ...
                                    <Col>
                                        <label style={{ fontSize: '25px', fontWeight: 'bold', color: '#000947', marginLeft: '90px' }} >{this.state.firstWeightData.driver_name}</label>
                                    </Col>
                                ...
                                <Row style={{ marginTop: '20px' }}>
                                    ...
                                    <Col>
                                        <label style={{ fontSize: '25px', fontWeight: 'bold', color: '#000947', marginLeft: '90px' }} >{this.state.firstWeightData.license_plate}</label>
                                    </Col>
                                ...
                                <Row style={{ marginTop: '20px' }}>
                                    ...
                                    <Col>
                                        <label style={{ fontSize: '25px', fontWeight: 'bold', color: '#000947', marginLeft: '90px' }} >{this.state.firstWeightData.tara_to}</label>
                                    </Col>
