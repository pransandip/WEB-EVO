...
class WaittodriveAbnahmeSchlackeEingangswaage extends Component {
    ...
    gotoNext() {
        this.props.history.push('WaittodriveTimerAbnahmeSchlackeEingangswaage');
    }
...
export default WaittodriveAbnahmeSchlackeEingangswaage;
