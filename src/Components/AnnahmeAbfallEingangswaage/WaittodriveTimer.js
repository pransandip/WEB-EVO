...
class WaittodriveTimerAnnahmeAbfallEingangswaage extends Component {
    ...
    gotoHome() {
        this.props.history.push('AnnahmeAbfallEingangswaageHome');
    }
...
export default WaittodriveTimerAnnahmeAbfallEingangswaage;
