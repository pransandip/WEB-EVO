...
class WaittodriveAnnahmeAbfallEingangswaage extends Component {
    ...
    gotoNext() {
        this.props.history.push('WaittodriveTimerAnnahmeAbfallEingangswaage');
    }
            ...
            <div style={{
                ...
                <Row style={{ marginTop: '100px' }}>
                        <div style={{ marginTop: '130px', marginLeft: 'auto', marginRight: 'auto', width: '615px', textAlign:'center' }}>
                            <label style={{ fontSize: '25px', fontWeight: 'bold', color: '#000947', marginLeft: '20px', marginTop: '14px' }} >{localLangData[localStorage.getItem('lang')].waittodrivelbl_Annahme_Abfall}</label>
                        </div>
                    </Row>
                </Container>
                <Row>
...
export default WaittodriveAnnahmeAbfallEingangswaage;
