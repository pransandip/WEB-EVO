...
class SignatureLableAnnahmeKalkTerminal extends Component {
    ...
    gotoNext() {
        this.props.history.push('PointInstructionAnnahmeKalkTerminal');
    }
...
export default SignatureLableAnnahmeKalkTerminal;
