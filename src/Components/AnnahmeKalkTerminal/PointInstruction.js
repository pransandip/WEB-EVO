...
class PointInstructionAnnahmeKalkTerminal extends Component {
    ...
    gotoNext() {
        this.props.history.push('ThanksLayoutAnnahmeKalkTerminal');
    }
...
export default PointInstructionAnnahmeKalkTerminal;
