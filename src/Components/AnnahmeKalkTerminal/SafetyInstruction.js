...
class SafetyInstructionAnnahmeKalkTerminal extends Component {
    ...
    cancelButtonMethod() {
        this.props.history.push('SafetynegationAnnahmeKalkTerminal');
    }

    checkedButtonMethod() {
        this.props.history.push('SignatureLableAnnahmeKalkTerminal');
    }
    gotoBack() {
...
export default SafetyInstructionAnnahmeKalkTerminal;
