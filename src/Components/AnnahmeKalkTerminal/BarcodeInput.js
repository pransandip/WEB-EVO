...
class BarcodeInputAnnahmeKalkTerminal extends Component {
  ...
  gotoNext() {
    if (this.state.barcodeInputValue === '') {
      ...
      this.props.history.push('SafetyInstructionAnnahmeKalkTerminal');
...
export default BarcodeInputAnnahmeKalkTerminal;
