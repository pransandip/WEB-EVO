...
class BarcodeScanAnnahmeKalkTerminal extends Component {
    ...
    gotoNext() {
        this.props.history.push('BarcodeInputAnnahmeKalkTerminal');
    }
...
export default BarcodeScanAnnahmeKalkTerminal;
