...
var tempintervalid = '';
class ThanksLayoutAnnahmeFlugasche extends Component {
    ...
    componentDidMount() {
        ...
        tempintervalid = setInterval(() => { this.props.history.push('AnnahmeFlugascheHome') }, 3000)
...
export default ThanksLayoutAnnahmeFlugasche;
