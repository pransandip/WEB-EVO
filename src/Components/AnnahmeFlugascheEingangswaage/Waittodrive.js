...
class WaittodriveAnnahmeFlugascheEingangswaage extends Component {
    ...
    gotoNext() {
        this.props.history.push('WaittodriveTimerAnnahmeFlugascheEingangswaage');
    }
...
export default WaittodriveAnnahmeFlugascheEingangswaage;
