...
class PointInstructionAnnahmeNabiTerminal extends Component {
    ...
    gotoNext() {
        this.props.history.push('ThanksLayoutAnnahmeNabiTerminal');
    }

    gotoHome() {
        this.props.history.push('AnnahmeNabiTerminalHome');
    }
             ...
             <div  style={{
                ...
                <Row style={{ marginTop: '100px' }}>
                        <div style={{ marginTop: '130px', marginLeft: 'auto', marginRight: 'auto', width: '650px', textAlign:'center' }}>
                            <label style={{ fontSize: '25px', fontWeight: 'bold', color: '#000947', marginLeft: '20px', marginTop: '14px' }} >{localLangData[localStorage.getItem('lang')].pointinstructionlbl_9}</label>
                        </div>
                    </Row>
                </Container>
                <Row>
...
export default PointInstructionAnnahmeNabiTerminal;
