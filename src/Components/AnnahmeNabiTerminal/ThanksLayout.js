...
var tempintervalid = '';
class ThanksLayoutAnnahmeNabiTerminal extends Component {
    ...
    componentDidMount() {
        ...
        tempintervalid = setInterval(() => { this.props.history.push('AnnahmeNabiTerminalHome') }, 3000)
...
export default ThanksLayoutAnnahmeNabiTerminal;
