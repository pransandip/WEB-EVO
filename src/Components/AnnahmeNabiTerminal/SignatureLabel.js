...
class SignatureLableAnnahmeNabiTerminal extends Component {
    ...
    gotoNext() {
        this.props.history.push('PointInstructionAnnahmeNabiTerminal');
    }
...
export default SignatureLableAnnahmeNabiTerminal;
