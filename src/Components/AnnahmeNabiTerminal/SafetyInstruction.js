...
class SafetyInstructionAnnahmeNabiTerminal extends Component {
    ...
    cancelButtonMethod() {
        this.props.history.push('SafetynegationAnnahmeNabiTerminal');
    }

    checkedButtonMethod() {
        this.props.history.push('SignatureLableAnnahmeNabiTerminal');
    }
    gotoBack() {
...
export default SafetyInstructionAnnahmeNabiTerminal;
