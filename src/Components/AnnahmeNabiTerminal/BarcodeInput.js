...
class BarcodeInputAnnahmeNabiTerminal extends Component {
  ...
  gotoNext() {
    if (this.state.barcodeInputValue === '') {
      ...
      this.props.history.push('SafetyInstructionAnnahmeNabiTerminal');
...
export default BarcodeInputAnnahmeNabiTerminal;
