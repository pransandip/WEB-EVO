...
class BarcodeScanAnnahmeNabiTerminal extends Component {
    ...
    gotoNext() {
        this.props.history.push('BarcodeInputAnnahmeNabiTerminal');
    }
...
export default BarcodeScanAnnahmeNabiTerminal;
