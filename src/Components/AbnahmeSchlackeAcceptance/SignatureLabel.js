...
class SignatureLableSchlackeAcceptance extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.order_second_detail_data) {
            ...
            this.props.history.push('ThanksLayoutSchlackeAcceptance', {
    ...
    gotoNext() {
        this.props.history.push('OverLayoutSchlackeAcceptance');
    }

    gotoHome() {
        this.props.history.push('AbnahmeSchlackeAcceptanceHome');
    }
...
export default connect(mapStateToProps, mapDispatchToProps) (SignatureLableSchlackeAcceptance);
