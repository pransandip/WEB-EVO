...
class BarcodeInputSchlackeAcceptance extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.first_weight_data && nextProps.first_weight_data.data.length > 0 ) {
      ...
      this.props.history.push('SignatureLableSchlackeAcceptance', {
        state: {
...
export default connect(mapStateToProps, mapDispatchToProps)(BarcodeInputSchlackeAcceptance);
