...
class PointInstructionAnnahmeFlugascheTerminal extends Component {
    ...
    gotoNext() {
        this.props.history.push('ThanksLayoutAnnahmeFlugascheTerminal');
    }

    gotoHome() {
        this.props.history.push('AnnahmeFlugascheTerminalHome');
    }
        ...
        return (
            <div style={{
                ...
                <Row style={{ marginTop: '100px' }}>
                        <div style={{ marginTop: '130px', marginLeft: 'auto', marginRight: 'auto', width: '650px', textAlign:'center' }}>
                            <label style={{ fontSize: '25px', fontWeight: 'bold', color: '#000947', marginLeft: '20px', marginTop: '14px' }} >{localLangData[localStorage.getItem('lang')].pointinstructionlbl_8}</label>
                        </div>
                    </Row>
                </Container>
                <Row>
...
export default PointInstructionAnnahmeFlugascheTerminal;
