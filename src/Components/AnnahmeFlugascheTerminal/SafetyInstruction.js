...
class SafetyInstructionAnnahmeFlugascheTerminal extends Component {
    ...
    cancelButtonMethod() {
        this.props.history.push('SafetynegationAnnahmeFlugascheTerminal');
    }

    checkedButtonMethod() {
        this.props.history.push('SignatureLableAnnahmeFlugascheTerminal', {
            state: {
              authToken: this.props.location.state.state.authToken,
              first_weight_data: this.props.location.state.state.first_weight_data,
            }
          });
    }
    gotoBack() {
...
export default SafetyInstructionAnnahmeFlugascheTerminal;
