...
var tempintervalid = '';
class ThanksLayoutAnnahmeFlugascheTerminal extends Component {
    ...
    componentDidMount() {
        ...
        tempintervalid = setInterval(() => { this.props.history.push('AnnahmeFlugascheTerminalHome') }, 3000)
...
export default ThanksLayoutAnnahmeFlugascheTerminal;
