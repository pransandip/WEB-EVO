...
class SignatureLableAnnahmeFlugascheTerminal extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.order_second_detail_data) {
            ...
            this.props.history.push('PointInstructionAnnahmeFlugascheTerminal', {
                ...
                <Container style={{ background: '', height: '435px' }} >
                    <Row style={{ marginTop: '100px' }}>
                        ...
                        <div style={{marginLeft:'auto', marginRight:'auto', width:'750px'}}>
                            <label style={{ fontSize: '25px', fontWeight: 'bold', color: '#000947', marginLeft: '65px' }} >{localLangData[localStorage.getItem('lang')].signature_label}</label>
                        </div>
                        <Col>
...
export default SignatureLableAnnahmeFlugascheTerminal;
