...
class BarcodeScanAnnahmeFlugascheTerminal extends Component {
    ...
    gotoNext() {
        ...
        this.props.history.push('BarcodeInputAnnahmeFlugascheTerminal', {
...
export default BarcodeScanAnnahmeFlugascheTerminal;
