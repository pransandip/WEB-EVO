...
class BarcodeScanAnnahmeAmmoniakwasser extends Component {
    ...
    gotoNext() {
        ...
        this.props.history.push('BarcodeInputAnnahmeAmmoniakwasser',{
...
export default BarcodeScanAnnahmeAmmoniakwasser;
