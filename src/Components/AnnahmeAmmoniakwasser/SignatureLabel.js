...
class SignatureLableAnnahmeAmmoniakwasser extends Component {
    ...
    gotoNext() {
        this.props.history.push('OverLayoutAnnahmeAmmoniakwasser');
    }

    gotoHome() {
        this.props.history.push('AnnahmeAmmoniakwasserHome');
    }
...
export default connect(mapStateToProps, mapDispatchToProps) (SignatureLableAnnahmeAmmoniakwasser);
