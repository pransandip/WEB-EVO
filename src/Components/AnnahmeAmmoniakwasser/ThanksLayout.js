...
var tempintervalid = '';
class ThanksLayoutAnnahmeAmmoniakwasser extends Component {
    ...
    componentDidMount() {
        ...
        tempintervalid = setInterval(() => { this.props.history.push('AnnahmeAmmoniakwasserHome') }, 3000)
...
export default ThanksLayoutAnnahmeAmmoniakwasser;
