...
class SignatureLableAnnahmeKalk extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.order_second_detail_data) {
            ...
            this.props.history.push('ThanksLayoutAnnahmeKalk', {
    ...
    gotoNext() {
        this.props.history.push('OverLayoutAnnahmeKalk');
    }

    gotoHome() {
        this.props.history.push('AnnahmeKalkHome');
    }
...
export default connect(mapStateToProps, mapDispatchToProps) (SignatureLableAnnahmeKalk);
