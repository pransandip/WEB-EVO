...
class BarcodeInputAnnahmeKalk extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.first_weight_data && nextProps.first_weight_data.data.length > 0 ) {
      ...
      this.props.history.push('SignatureLableAnnahmeKalk', {
        state: {
...
export default connect(mapStateToProps, mapDispatchToProps)(BarcodeInputAnnahmeKalk);
