...
var tempintervalid = '';
class ThanksLayoutKlarschlamm extends Component {
    ...
    componentDidMount() {
        ...
        tempintervalid = setInterval(() => { this.props.history.push('AnnahmeKlarschlammHome') }, 3000)
...
export default ThanksLayoutKlarschlamm;
