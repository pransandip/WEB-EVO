...
class BarcodeInputKlarschlamm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showHomeIcon: false,
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.first_weight_data && nextProps.first_weight_data.data.length > 0) {
      ...
      this.props.history.push('SignatureLableKlarschlamm', {
        state: {
...
export default connect(mapStateToProps, mapDispatchToProps)(BarcodeInputKlarschlamm);
