...
class SignatureLableKlarschlamm extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.order_second_detail_data) {
            ...
            this.props.history.push('ThanksLayoutKlarschlamm', {
    ...
    gotoHome() {
        this.props.history.push('AnnahmeKlarschlammHome');
    }
...
export default connect(mapStateToProps, mapDispatchToProps) (SignatureLableKlarschlamm);
