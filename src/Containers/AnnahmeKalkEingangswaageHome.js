...
class AnnahmeKalkEingangswaageHome extends Component {
    ...
    imageClicked(params) {
        ...
        this.props.history.push('WaittodriveAnnahmeKalkEingangswaage', {
...
export default AnnahmeKalkEingangswaageHome;