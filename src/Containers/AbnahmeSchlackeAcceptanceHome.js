...
class AbnahmeSchlackeAcceptanceHome extends Component {
    ...
    imageClicked(params, language) {
        if (this.props.user_auth_token) {
            ...
            this.props.history.push('BarcodeScanSchlackeAcceptance', {
...
export default connect(mapStateToProps, mapDispatchToProps)(AbnahmeSchlackeAcceptanceHome);
