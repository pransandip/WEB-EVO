...
class AnnahmeKlärschlammEingangswaageHome extends Component {
    ...
    imageClicked(params) {
        ...
        this.props.history.push('WaittodriveAnnahmeKlärschlammEingangswaage', {
...
export default AnnahmeKlärschlammEingangswaageHome;