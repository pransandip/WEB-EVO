...
class AnnahmeNabiHome extends Component {
    ...
    imageClicked(params, language) {
        if (this.props.user_auth_token) {
            ...
            this.props.history.push('BarcodeScanAnnahmeNabi', {
...
export default connect(mapStateToProps, mapDispatchToProps)(AnnahmeNabiHome);
