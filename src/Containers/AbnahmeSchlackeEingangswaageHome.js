...
class AbnahmeSchlackeEingangswaageHome extends Component {
    ...
    imageClicked(params) {
        ...
        this.props.history.push('WaittodriveAbnahmeSchlackeEingangswaage', {
...
export default AbnahmeSchlackeEingangswaageHome;