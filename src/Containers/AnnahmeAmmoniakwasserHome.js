...
class AnnahmeAmmoniakwasserHome extends Component {
    ...
    imageClicked(params, language) {
        if (this.props.user_auth_token) {
            ...
            this.props.history.push('BarcodeScanAnnahmeAmmoniakwasser', {
...
export default connect(mapStateToProps, mapDispatchToProps)(AnnahmeAmmoniakwasserHome);
