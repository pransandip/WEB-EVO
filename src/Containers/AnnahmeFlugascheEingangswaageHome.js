...
class AnnahmeFlugascheEingangswaageHome extends Component {
    ...
    imageClicked(params) {
        ...
        this.props.history.push('WaittodriveAnnahmeFlugascheEingangswaage', {
...
export default AnnahmeFlugascheEingangswaageHome;