...
class AnnahmeFlugascheHome extends Component {
    ...
    imageClicked(params, language) {
        if (this.props.user_auth_token) {
            ...
            this.props.history.push('BarcodeScanAnnahmeFlugasche', {
...
export default connect(mapStateToProps, mapDispatchToProps)(AnnahmeFlugascheHome);
