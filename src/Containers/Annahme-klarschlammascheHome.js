...
class AnnahmeklarschlammascheHome extends Component {
    ...
    imageClicked(params, language) {
        if (this.props.user_auth_token) {
            ...
            this.props.history.push('BarcodeScanklarschlammasche', {
...
export default connect(mapStateToProps, mapDispatchToProps)( AnnahmeklarschlammascheHome);
