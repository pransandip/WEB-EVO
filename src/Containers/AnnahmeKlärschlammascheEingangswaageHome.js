...
class AnnahmeKlärschlammascheEingangswaageHome extends Component {
    ...
    imageClicked(params) {
        ...
        this.props.history.push('WaittodriveAnnahmeKlärschlammascheEingangswaage', {
...
export default AnnahmeKlärschlammascheEingangswaageHome;