...
class AnnahmeKalkHome extends Component {
    ...
    imageClicked(params, language) {
        if (this.props.user_auth_token) {
            ...
            this.props.history.push('BarcodeScanAnnahmeKalk', {
...
export default connect(mapStateToProps, mapDispatchToProps)(AnnahmeKalkHome);
