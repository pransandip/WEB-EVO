...
class AnnahmeKlärschlammascheTerminalHome extends Component {
    ...
    imageClicked(params) {
        ...
        this.props.history.push('BarcodeScanAnnahmeKlärschlammascheTerminal', {
...
export default AnnahmeKlärschlammascheTerminalHome;